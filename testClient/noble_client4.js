        ...
        console.log("비콘을 찾았습니다. UUID 는 "+ peripheral.uuid+"입니다.");
          ...
          if(Object.keys(beacons).indexOf(peripheral.uuid)==-1){
            ...
            peripheral.on('disconnect',function(){
              ...
              beacons[peripheral.uuid].updateRssi = function(){}
              beacons[peripheral.uuid].removeListener = function(a,next){
                next(a);
              }

              //peripheral.removeListener('disconnect',function(){});
              noble.stopScanning();
              noble.startScanning();
              console.log("Started scanning");
            });
            ...
            peripheral.on('rssiUpdate',function(rssi){
              ...
              if(beacons_update==beacons_count){
                beacons_update=0;
